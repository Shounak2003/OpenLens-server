...
declare const ThreeDSchema: z.ZodObject<{
    ...
    $schema: PublicationSchemaId.THREE_D_LATEST;
    lens: PublicationMetadataCommon & {
        /**
         * The main focus of the publication.
         */
        mainContentFocus: PublicationMainFocus.THREE_D;
